...
def train_model(model, train_loader, val_loader, test_loader, criterion, optimizer, num_epochs,log_file_path):
    ...
    for epoch in range(num_epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), './Saved_Model/SAV_soft_164_4.pth')
    ...
    # Load the best model
    model.load_state_dict(torch.load('./Saved_Model/SAV_soft_164_4.pth'))
...
train_path = '/home/mainak/MDU/FrequencyConv/data/Dataset_SAT/train'
val_path = '/home/mainak/MDU/FrequencyConv/data/Dataset_SAT/val'
test_path = '/home/mainak/MDU/FrequencyConv/data/Dataset_SAT/test'
...
transform_train = transforms.Compose([
    ...
    transforms.ToTensor(),  # Equivalent to rescale=1./255 (normalizes values between 0 and 1)
     transforms.Normalize(mean=[0.5851, 0.6580, 0.7062], std=[0.3993, 0.3537, 0.3023])  # featurewise_std_normalization=True
])
...
#from torchsummary import summary#import torchinfo 
...
# Train the model
log_file = "SAV_16_training_logs_164_4.csv"
train_losses, val_losses, train_accuracies, val_accuracies = train_model(model, trainloader_fft, validationloader_fft, testloader_fft, 
    criterion, optimizer, num_epochs=300, log_file_path=log_file)
